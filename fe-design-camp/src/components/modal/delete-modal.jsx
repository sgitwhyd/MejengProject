...
export default function DeleteModal({ setIsDelete, deleteId }) {
  return (
    <div className="absolute inset-0 z-[99] mx-auto my-auto h-[230px] w-[478px] rounded-2xl border bg-white p-6 shadow-lg drop-shadow-xl">
      <div className="relative flex h-full w-full flex-col items-center justify-center">
        ...
        <p className="text-center">
          Anda akan menghapus <span className="font-semibold">{deleteId}</span>
        ...
        <div className="mt-8 flex gap-4">
          ...
          <button className="btn-success btn-sm btn text-white">Delete</button>
        </div>
      </div>
    </div>
  );
