...
export default function Navbar() {
  ...
  return (
    <nav className="absolute w-full shadow-md">
      <div className="mx-auto flex h-16 max-w-screen-2xl items-center justify-between px-5 md:px-[47px] lg:h-20">
        {/* Mobile View */}
        ...
        {/* Desktop View */}
        <div className="hidden items-center justify-center gap-12 font-medium lg:flex">
          <Link href="/">
            <Image src={logo} alt="logo" height={30} />
          </Link>
          <Link href="/project/inspirations">Inspirations</Link>
        ...
        <div className="flex items-center justify-center gap-11">
          {login ? (
            ...
            <>
              ...
              <Link
                href={"/auth/login"}
                className="block rounded-lg bg-primary py-3 px-6 text-sm font-bold text-white hover:text-white lg:hidden"
              >
                Login
              </Link>
              {/* Dekstop View */}
