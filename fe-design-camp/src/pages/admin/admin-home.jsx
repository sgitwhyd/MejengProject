...
export default function AdminHome() {
	const { ammount_users } = useSelector(selectAdmin);

	console.log(ammount_users);

	const datas = [
		{ name: 'All Post', total: 346 },
		{ name: 'Active User', total: ammount_users },
	...
	return (
		<>
			...
			<section className='mt-10 grid  grid-cols-4 gap-10'>
				<div className='flex cursor-pointer items-center justify-center gap-5 rounded-2xl bg-white p-6 shadow-md'>
